...
export const translations = {
  es: {
    ...
    gameSetup: {
      ...
      impostorHints: "Pistas para impostor",
      impostorHintsDescription: "Mostrar pistas al impostor",
      crazyMode: "Modo Loco",
      crazyModeDescription: "¡Modo caótico! Todos pueden ser impostores o tener palabras diferentes",
  ...
  en: {
    ...
    gameSetup: {
      ...
      impostorHints: "Hints for impostor",
      impostorHintsDescription: "Show hints to the impostor",
      crazyMode: "Crazy Mode",
      crazyModeDescription: "Chaotic mode! Everyone can be impostors or have different words",
